...
Ideally, pen and paper was my goto way of getting things done on a regular basis. I actually prefer this way as the act of writing things down allows my brain to register all tasks I need to do. It allows me to focus.
...
To solve this problem, I landed using Microsoft Todo after many different attempts on finding a good todo app. The reason why this is so good is that it is very easy to use and it's very simple. It also integrates with Outlook in a way that's a game changer in my opinion.

![Microsoft Todo](../assets/microsoft_todo.png)
![Microsoft Todo](../assets/microsoft_todo2.png)

// how do I organize my tasks
I organize my Todo list into two buckets. Work and Personal. I used to used one, but definitely it is not scaling. The Work and Personal list act as backlogs. And I use the "My Day" feature as my queue on what work I will be doing throughout the day.

The idea is to keep the task high level and use the subtask for more detailed approach. If a task is too high level, I notice the work does not get done. The path to success involves clarity.

// what is the mostly common features I use

The common features I use to reenforce getting the work done is due dates and reminders. These are alerts to capture your attention. They tell you that something needs attention. It is definitely annoying, resisting the urge to ignore them is a personal challenge, but I am grateful this feature exist.

// ability to see todo on any device
Having constant visiblity on the backlog of tasks is important. One of the main reason why we are productive using a pen and notebook is that is is always visible. Leveraging technology makes it so that we can see our team on multiple screens. It is also, more "green" to compared to using paper.

// ability to share lists

Microsoft todo also allows other people to see your personal list by sharing it via a web link. This will give people the ability to view or edit the list. Which can be powerful as it can act as a project management tool.
...
To counter this, I began eating less rice more and more. White rice was something I ate in large amounts for lunch and dinner and lately, I have completely removed it from my diet. Or at least eating very minimal. My goal is to eat way more nutricious foods, rather than comfort food. It is important to regulate energy levels.
...
// keep up with any notifications that arises on my phone
